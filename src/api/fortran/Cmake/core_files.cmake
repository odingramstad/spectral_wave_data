...
if (CMAKE_Fortran_COMPILER_ID STREQUAL "Intel")
  ...
  if (UNIX)
    ...
    set(CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS "${CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS} -L${MKLROOT}/lib/intel64 -lmkl_rt -lpthread -lm -ldl")
  endif()
  if (WIN32)
    message("SWD: enabling /static for .lib files")
    set(CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS "${CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS} mkl_rt.lib")
  endif()
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "GNU" AND UNIX)
  ...
  set(CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS "${CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS} ${FFTW_LIBRARIES}")
endif()
